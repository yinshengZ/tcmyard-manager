<template>
    <div>
        <div class="add-item-button">
            <el-button class="button" style="width:100%; padding:10px;" @click="add_item_row" type="success"
                icon="el-icon-plus">Item</el-button>

        </div>

        <div v-if="retail_details.length">
            <el-form v-model="retail_details" label-width="120px" label-position="left">
                <el-form-item v-for="(retail, index) in retail_details" :label="'Item ' + (index + 1)">

                    <el-select v-model="retail.id" filterable placeholder="retails...">
                        <el-option v-for="retail_list in all_retails" :key="retail_list.id"
                    ...
                    <el-input-number v-model="retail.units" :min="1" :max="99999999" :step="1"
                        placeholder="units"></el-input-number>

                    <el-button style="padding:10px; margin-left:10px"
                ...
                <div v-if="with_finance">
                    ...
                    <el-form-item label="Price (£): ">
                        <el-input-number v-model="final_amount">

                        </el-input-number>
                        <el-button style="margin-left:10px" @click="calculate_price" type="primary">Calculate</el-button>
                    </el-form-item>
                    <el-form-item label="Normal Price(£):" label-width="120px" v-model="original_amount">
                    ...
                    <el-form-item label="Description">
                        <el-input v-model="description" type="textarea" :rows="2"></el-input>
                    </el-form-item>
