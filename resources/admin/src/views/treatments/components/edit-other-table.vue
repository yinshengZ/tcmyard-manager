  ...
  <div>
    <el-card shadow="always">
      ...
      <el-form v-model="treatment_detail" label-width="120px">
        ...
        <el-form-item
        label="Quantity">
            <el-input-number v-model="quantity" :min="1" :max="999999999" :step="1"> </el-input-number>
          </el-form-item>

          <el-form-item
          label="Discount (%)">
          <el-input-number v-model="discount" :min="0" :max="999999999" :step="1"></el-input-number>
        </el-form-item>

        <el-form-item>
          <el-button type="primary" @click="update_others()">Update</el-button>
        </el-form-item>
      </el-form>
    </el-card>
  </div>
...
export default {
  ...
  methods: {
    ...
    update_others(){
      ...
      updateOthers(this.final_detail).then((response)=>{
        this.$notify({
          title:'Notification',
