    ...
    <div>
        <el-form>
            ...
            <el-form-item label="Disease:">
                <el-select v-model="diseases" multiple filterable>
                    <el-option v-for="disease in all_diseases" :key="disease.id" :label="disease.disease"
        ...
        <el-dialog :visible.sync="add_disease_form_loaded" :beforeClose="get_all_diseases" width="30%" append-to-body>
